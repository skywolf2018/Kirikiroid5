...
public class Cocos2dxWebViewHelper {
    ...
    public static boolean canGoBack(final int index) {
        Callable<Boolean> callable = new Callable<Boolean>() { // from class: org.cocos2dx.lib.Cocos2dxWebViewHelper.12
    ...
    public static boolean canGoForward(final int index) {
        Callable<Boolean> callable = new Callable<Boolean>() { // from class: org.cocos2dx.lib.Cocos2dxWebViewHelper.13
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // java.util.concurrent.Callable
            public Boolean call() throws Exception {
                Cocos2dxWebView webView = (Cocos2dxWebView) Cocos2dxWebViewHelper.webViews.get(index);
